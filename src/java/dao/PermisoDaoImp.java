...
public class PermisoDaoImp implements PermisoDao {
    ...
    public LinkedList<PermisoDto> listAllPermisos() {
        LinkedList<PermisoDto> permisos = new LinkedList<>();
        try {
            Connection con = Conexion.getConexion();
            String sql = "SELECT "
    ...
    public LinkedList<PermisoDto> listeUnidadPermisos(int unidadId) {
        LinkedList<PermisoDto> permisos = new LinkedList<>();
        try {
            Connection con = Conexion.getConexion();
            String sql = "SELECT "
    ...
    public PermisoDto buscarPermiso(int id) {
        ...
        {
            System.out.println("PermisoDaoImp.buscarPermiso Error sql: "+sqlex.getMessage());
        }
        catch(Exception ex)
        {
            System.out.println("PermisoDaoImp.buscarPermiso Error: "+ex.getMessage());
        }
        return dto;
    }
}
